...
export const getAskTutorUrl = () => {
  return `/api/learn/ask`;
};

export const askTutor = async (
  askTutorBody: AskTutorBody,
  options?: RequestInit,
): Promise<unknown> => {
  return customFetch<unknown>(getAskTutorUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(askTutorBody),
  });
};

export const getAskTutorMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AskTutorMutationResult = NonNullable<
  Awaited<ReturnType<typeof askTutor>>
>;
export type AskTutorMutationBody = BodyType<AskTutorBody>;
